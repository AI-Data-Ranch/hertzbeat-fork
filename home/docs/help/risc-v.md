...
sudo tar -xzf OpenJDK21U-jdk_riscv64_linux_hotspot_21.0.7_6.tar.gz -C /usr/lib/jvm
...
> Notes:
>
> 1. Replace `OpenJDK21U-jdk_riscv64_linux_hotspot_21.0.7_6.tar.gz` with your actual JDK filename.
